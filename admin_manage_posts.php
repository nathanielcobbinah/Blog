    ...
    <div class="container mx-auto px-4 py-8 flex flex-wrap">
        ...
        <div class="w-full md:w-3/4 bg-gray-800 rounded-lg shadow-md p-6 overflow-x-auto">
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="create_post_form.php" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">Create New Post</a>
            </div>
            ...
            <table class="w-full border-collapse border border-gray-600">
                ...
                <tbody>
                    ...
                    $sql_posts = "SELECT posts.id, posts.title, posts.created_at FROM posts ";
                    ...
                    if ($result_posts->num_rows > 0) {
                        ...
                        while ($row = $result_posts->fetch_assoc()) {
                            ...
                            // echo "<td class='py-2 px-4 border border-gray-600'>" . htmlspecialchars($row['author']) . "</td>";
                            echo "<td class='py-2 px-4 border border-gray-600'>Admin</td>";
                            echo "<td class='py-2 px-4 border border-gray-600'>" . htmlspecialchars($row['created_at']) . "</td>";
                            echo "<td class='py-2 px-4 border border-gray-600'>";
                            echo "<a href='edit_post.php?id=" . intval($row['id']) . "' class='bg-blue-500 text-white px-3 py-1 rounded-md hover:bg-blue-600'>Edit</a>";
                            echo "<form action='delete_post.php' method='post' class='inline-block ml-2'>";
                            echo "<input type='hidden' name='post_id' value='" . intval($row['id']) . "'>";
                            echo "<button type='submit' class='bg-red-500 text-white px-3 py-1 rounded-md hover:bg-red-600'>Delete</button>";
                            echo "</form>";
                            echo "</td>";
                            echo "</tr>";
                        }
